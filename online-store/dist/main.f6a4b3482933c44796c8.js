...
/* harmony import */ var _assets_svg_cart_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../assets/svg/cart.svg */ "./src/assets/svg/cart.svg");
/* harmony import */ var _assets_svg_x_icon_svg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../assets/svg/x-icon.svg */ "./src/assets/svg/x-icon.svg");
// Imports
...
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(_assets_svg_cart_svg__WEBPACK_IMPORTED_MODULE_3__);
var ___CSS_LOADER_URL_REPLACEMENT_1___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(_assets_svg_x_icon_svg__WEBPACK_IMPORTED_MODULE_4__);
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header {\n  max-width: 1200px;\n  margin: 0 auto;\n}\n.header .header-wrapper {\n  display: grid;\n  grid-template-columns: 30% 50% 20%;\n  justify-items: center;\n  align-items: center;\n  justify-content: space-between;\n  width: 95%;\n  margin: 0 auto;\n}\n.header .header-wrapper h1 {\n  font-size: 40px;\n  font-weight: 800;\n  cursor: pointer;\n}\n.header .cart-button {\n  position: relative;\n  justify-self: right;\n  padding-right: 10px;\n  width: 50px;\n  height: 50px;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n  background-repeat: no-repeat;\n  cursor: pointer;\n}\n.header .cart-total {\n  position: relative;\n}\n.header .cart__counter {\n  position: relative;\n  left: 36px;\n  bottom: 11px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 15px;\n  height: 15px;\n  border: 2px solid white;\n  border-radius: 30px;\n  padding: 3px;\n}\n\n.filters-section {\n  padding-left: 12px;\n}\n\n.cards__list {\n  display: grid;\n  grid-template-columns: repeat(5, 1fr);\n  /* grid-template-rows: repeat(5, 1fr); */\n  grid-column-gap: 5px;\n  grid-row-gap: 5px;\n}\n\nli {\n  list-style-type: none;\n  border: solid 1px white;\n}\nli .card {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: center;\n  height: 100%;\n}\n\n.pop-up-background {\n  display: none;\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100vw;\n  height: 100vh;\n  z-index: 4;\n  background-color: rgba(0, 0, 0, 0.8);\n}\n.pop-up-background.open {\n  display: block;\n}\n.pop-up-background .modal {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  z-index: 5;\n  width: 70%;\n  height: 70%;\n  display: flex;\n  align-items: center;\n  justify-content: space-around;\n  border: solid 2px transparent;\n  background: rgb(233, 233, 233);\n  border-radius: 5px;\n}\n.pop-up-background .modal .modal-text-container {\n  width: 55%;\n  color: #000000;\n}\n.pop-up-background .pop-up-close-button {\n  display: block;\n  position: absolute;\n  right: 3%;\n  top: 25px;\n  width: 15px;\n  height: 15px;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ");\n  background-repeat: no-repeat;\n  border: none;\n  cursor: pointer;\n  transition: all 0.5s;\n}\n.pop-up-background .pop-up-close-button:hover {\n  transform: scale(1.2);\n  transition: all 0.3s;\n}\n\n.cart__section {\n  display: none;\n}\n.cart__section.open {\n  display: block;\n}\n.cart__section .product-item {\n  display: flex;\n  justify-content: flex-start;\n  align-items: center;\n}\n.cart__section .product-buy-info {\n  display: flex;\n  align-items: center;\n}\n\n*:focus {\n  outline: none;\n}\n\n.form__section {\n  display: none;\n  width: 50%;\n  padding-top: 50px;\n  margin: 0 auto;\n}\n.form__section.open {\n  display: block;\n}\n.form__section .order-form {\n  -webkit-appearance: none;\n     -moz-appearance: none;\n          appearance: none;\n  display: flex;\n  flex-direction: column;\n}\n.form__section .label {\n  display: flex;\n  flex-direction: column;\n  padding: 0.5em;\n}\n.form__section .input {\n  padding: 0.5em;\n  color: rgba(70, 70, 70, 0.2941176471);\n  font-weight: 300;\n  border: 1px solid rgba(70, 70, 70, 0.2941176471);\n  margin-top: 0.5em;\n}\n.form__section .input:focus:invalid {\n  border: 1px solid red;\n  color: red;\n}\n.form__section .input:focus:valid {\n  border: 1px solid green;\n  color: green;\n}\n.form__section fieldset {\n  margin-top: 0.5em;\n  margin-left: 0.5em;\n  width: 40%;\n}\n.form__section .cash-container,\n.form__section .card-container {\n  padding: 0.5em;\n}\n.form__section .cash-label,\n.form__section .card-label {\n  margin-left: 0.5em;\n}\n.form__section .input-button {\n  margin: 0.5em;\n}\n\nbody {\n  color: #fff;\n  background: rgba(23, 24, 28, 0.8352941176);\n  font-family: sans-serif;\n}\n\n.container.open {\n  display: grid;\n  grid-template-columns: 22% 75%;\n  grid-column-gap: 3%;\n}\n\n.container {\n  display: none;\n}", "",{"version":3,"sources":["webpack://./src/scss/components/_header.scss","webpack://./src/scss/main.scss","webpack://./src/scss/components/_filter-section.scss","webpack://./src/scss/components/_product-section.scss","webpack://./src/scss/components/_pop-up.scss","webpack://./src/scss/components/_cart.scss","webpack://./src/scss/components/_form.scss"],"names":[],"mappings":"AAAA;EACI,iBAAA;EACA,cAAA;ACCJ;ADAI;EACI,aAAA;EACA,kCAAA;EACA,qBAAA;EACA,mBAAA;EACA,8BAAA;EACA,UAAA;EACA,cAAA;ACER;ADDQ;EACI,eAAA;EACA,gBAAA;EACA,eAAA;ACGZ;ADAI;EACI,kBAAA;EACA,mBAAA;EACA,mBAAA;EACA,WAAA;EACA,YAAA;EACA,yDAAA;EACA,4BAAA;EACA,eAAA;ACER;ADAI;EACI,kBAAA;ACER;ADAI;EACI,kBAAA;EACA,UAAA;EACA,YAAA;EACA,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,WAAA;EACA,YAAA;EAEA,uBAAA;EACA,mBAAA;EACA,YAAA;ACCR;;AC3CA;EACE,kBAAA;AD8CF;;AE/CA;EACE,aAAA;EACA,qCAAA;EACA,wCAAA;EACA,oBAAA;EACA,iBAAA;AFkDF;;AE/CA;EACE,qBAAA;EACA,uBAAA;AFkDF;AEjDE;EACE,aAAA;EACA,sBAAA;EACA,8BAAA;EACA,mBAAA;EACA,YAAA;AFmDJ;;AGjEA;EACI,aAAA;EACA,eAAA;EACA,MAAA;EACA,OAAA;EACA,YAAA;EACA,aAAA;EACA,UAAA;EACA,oCAAA;AHoEJ;AGnEI;EACI,cAAA;AHqER;AGnEI;EACI,kBAAA;EACA,QAAA;EACA,SAAA;EACA,gCAAA;EACA,UAAA;EACA,UAAA;EACA,WAAA;EACA,aAAA;EACA,mBAAA;EACA,6BAAA;EACA,6BAAA;EACA,8BAAA;EACA,kBAAA;AHqER;AGpEQ;EACI,UAAA;EACA,cAAA;AHsEZ;AGnEI;EACI,cAAA;EACA,kBAAA;EACA,SAAA;EACA,SAAA;EACA,WAAA;EACA,YAAA;EACA,yDAAA;EACA,4BAAA;EACA,YAAA;EACA,eAAA;EACA,oBAAA;AHqER;AGpEQ;EACI,qBAAA;EACA,oBAAA;AHsEZ;;AIrHA;EACE,aAAA;AJwHF;AIvHE;EACE,cAAA;AJyHJ;AIvHE;EACE,aAAA;EACA,2BAAA;EACA,mBAAA;AJyHJ;AIvHE;EACE,aAAA;EACA,mBAAA;AJyHJ;;AKrIA;EACI,aAAA;ALwIJ;;AKrIA;EACI,aAAA;EACA,UAAA;EACA,iBAAA;EACA,cAAA;ALwIJ;AKvII;EACI,cAAA;ALyIR;AKvII;EACI,wBAAA;KAAA,qBAAA;UAAA,gBAAA;EACA,aAAA;EACA,sBAAA;ALyIR;AKvII;EACI,aAAA;EACA,sBAAA;EACA,cAAA;ALyIR;AKvII;EACI,cAAA;EACA,qCAAA;EACA,gBAAA;EACA,gDAAA;EACA,iBAAA;ALyIR;AKxIQ;EACI,qBAAA;EACA,UAAA;AL0IZ;AKxIQ;EACI,uBAAA;EACA,YAAA;AL0IZ;AKvII;EACI,iBAAA;EACA,kBAAA;EACA,UAAA;ALyIR;AKvII;;EAEI,cAAA;ALyIR;AKvII;;EAEI,kBAAA;ALyIR;AKvII;EACI,aAAA;ALyIR;;AArLA;EACI,WAAA;EACA,0CAAA;EACA,uBAAA;AAwLJ;;AArLA;EACI,aAAA;EACA,8BAAA;EACA,mBAAA;AAwLJ;;AArLA;EACI,aAAA;AAwLJ","sourcesContent":[".header {\r\n    max-width: 1200px;\r\n    margin: 0 auto;\r\n    .header-wrapper {\r\n        display: grid;\r\n        grid-template-columns: 30% 50% 20%;\r\n        justify-items: center;\r\n        align-items: center;\r\n        justify-content: space-between;\r\n        width: 95%;\r\n        margin: 0 auto;\r\n        h1 {\r\n            font-size: 40px;\r\n            font-weight: 800;\r\n            cursor: pointer;\r\n        }\r\n    }\r\n    .cart-button {\r\n        position: relative;\r\n        justify-self: right;\r\n        padding-right: 10px;\r\n        width: 50px;\r\n        height: 50px;\r\n        background-image: url(../assets/svg/cart.svg);\r\n        background-repeat: no-repeat;\r\n        cursor: pointer;\r\n    }\r\n    .cart-total {\r\n        position: relative;\r\n    }\r\n    .cart__counter {\r\n        position: relative;\r\n        left: 36px;\r\n        bottom: 11px;\r\n        display: flex;\r\n        align-items: center;\r\n        justify-content: center;\r\n        width: 15px;\r\n        height: 15px;\r\n        // color: red;\r\n        border: 2px solid white;\r\n        border-radius: 30px;\r\n        padding: 3px;\r\n    }\r\n}\r\n","@import \"../scss/components/header\";\r\n@import \"../scss/components/filter-section\";\r\n@import \"../scss/components/product-section\";\r\n@import \"../scss/components/pop-up\";\r\n@import \"../scss/components/cart\";\r\n@import \"../scss/components/form\";\r\n\r\nbody {\r\n    color: #fff;\r\n    background: #17181cd5;\r\n    font-family: sans-serif;\r\n}\r\n\r\n.container.open {\r\n    display: grid;\r\n    grid-template-columns: 22% 75%;\r\n    grid-column-gap: 3%;\r\n}\r\n\r\n.container {\r\n    display: none;\r\n}\r\n",".filters-section {\r\n  padding-left: 12px;\r\n}\r\n",".cards__list {\r\n  display: grid;\r\n  grid-template-columns: repeat(5, 1fr);\r\n  /* grid-template-rows: repeat(5, 1fr); */\r\n  grid-column-gap: 5px;\r\n  grid-row-gap: 5px;\r\n}\r\n\r\nli {\r\n  list-style-type: none;\r\n  border: solid 1px white;\r\n  .card {\r\n    display: flex;\r\n    flex-direction: column;\r\n    justify-content: space-between;\r\n    align-items: center;\r\n    height: 100%;\r\n  }\r\n}\r\n","// @import \"../abstracts/color-styles\";\r\n\r\n.pop-up-background {\r\n    display: none;\r\n    position: fixed;\r\n    top: 0;\r\n    left: 0;\r\n    width: 100vw;\r\n    height: 100vh;\r\n    z-index: 4;\r\n    background-color: rgba(0, 0, 0, 0.8);\r\n    &.open {\r\n        display: block;\r\n    }\r\n    .modal {\r\n        position: absolute;\r\n        top: 50%;\r\n        left: 50%;\r\n        transform: translate(-50%, -50%);\r\n        z-index: 5;\r\n        width: 70%;\r\n        height: 70%;\r\n        display: flex;\r\n        align-items: center;\r\n        justify-content: space-around;\r\n        border: solid 2px transparent;\r\n        background: rgb(233, 233, 233);\r\n        border-radius: 5px;\r\n        .modal-text-container {\r\n            width: 55%;\r\n            color: #000000;\r\n        }\r\n    }\r\n    .pop-up-close-button {\r\n        display: block;\r\n        position: absolute;\r\n        right: 3%;\r\n        top: 25px;\r\n        width: 15px;\r\n        height: 15px;\r\n        background-image: url(../assets/svg/x-icon.svg);\r\n        background-repeat: no-repeat;\r\n        border: none;\r\n        cursor: pointer;\r\n        transition: all 0.5s;\r\n        &:hover {\r\n            transform: scale(1.2);\r\n            transition: all 0.3s;\r\n        }\r\n    }\r\n}\r\n",".cart__section {\r\n  display: none;\r\n  &.open {\r\n    display: block;\r\n  }\r\n  .product-item {\r\n    display: flex;\r\n    justify-content: flex-start;\r\n    align-items: center;\r\n  }\r\n  .product-buy-info {\r\n    display: flex;\r\n    align-items: center;\r\n  }\r\n}\r\n","*:focus {\r\n    outline: none;\r\n}\r\n\r\n.form__section {\r\n    display: none;\r\n    width: 50%;\r\n    padding-top: 50px;\r\n    margin: 0 auto;\r\n    &.open {\r\n        display: block;\r\n    }\r\n    .order-form {\r\n        appearance: none;\r\n        display: flex;\r\n        flex-direction: column;\r\n    }\r\n    .label {\r\n        display: flex;\r\n        flex-direction: column;\r\n        padding: 0.5em;\r\n    }\r\n    .input {\r\n        padding: 0.5em;\r\n        color: #4646464b;\r\n        font-weight: 300;\r\n        border: 1px solid #4646464b;\r\n        margin-top: 0.5em;\r\n        &:focus:invalid {\r\n            border: 1px solid red;\r\n            color: red;\r\n        }\r\n        &:focus:valid {\r\n            border: 1px solid green;\r\n            color: green;\r\n        }\r\n    }\r\n    fieldset {\r\n        margin-top: 0.5em;\r\n        margin-left: 0.5em;\r\n        width: 40%;\r\n    }\r\n    .cash-container,\r\n    .card-container {\r\n        padding: 0.5em;\r\n    }\r\n    .cash-label,\r\n    .card-label {\r\n        margin-left: 0.5em;\r\n    }\r\n    .input-button {\r\n        margin: 0.5em;\r\n    }\r\n}\r\n"],"sourceRoot":""}]);
// Exports
...
exports.Cart = void 0;
const create_element_1 = __webpack_require__(/*! ./create-element */ "./src/components/create-element.ts");
const data_json_1 = __importDefault(__webpack_require__(/*! ../data.json */ "./src/data.json"));
class Cart {
    constructor() {
        this.cartContainer = (0, create_element_1.newTag)('section', { className: 'cart__section' });
        this.productsCart = (0, create_element_1.newTag)('div', { className: 'products__container' });
        this.productsPage = (0, create_element_1.newTag)('div', { className: 'products-page' });
        this.productsList = (0, create_element_1.newTag)('div', { className: 'products-list' });
        this.productItem = (0, create_element_1.newTag)('div', { className: 'product-item' });
        this.productImg = (0, create_element_1.newTag)('div', { className: 'product-img' });
        this.productInfo = (0, create_element_1.newTag)('div', { className: 'product-info' });
        this.productName = (0, create_element_1.newTag)('div', { className: 'product-name' });
        this.productRating = (0, create_element_1.newTag)('div', { className: 'product-rating' });
        this.productDiscount = (0, create_element_1.newTag)('div', { className: 'product-discount' });
        this.productBuyInfo = (0, create_element_1.newTag)('div', { className: 'product-buy-info' });
        this.productStock = (0, create_element_1.newTag)('div', { className: 'product-stock' });
        this.productAdd = (0, create_element_1.newTag)('button', {
            className: 'product-add',
            textContent: '+',
        });
        this.productCount = (0, create_element_1.newTag)('h3', {
            className: 'product-count',
            textContent: '0',
        });
        this.productTakeAway = (0, create_element_1.newTag)('button', {
            className: 'product-take-away',
            textContent: '-',
        });
        this.productPrice = (0, create_element_1.newTag)('h4', {
            className: 'product-price',
            textContent: '$0',
        });
        this.summaryContainer = (0, create_element_1.newTag)('div', { className: 'summary__container' });
        this.summaryTitle = (0, create_element_1.newTag)('h3', {
            className: 'summary-title',
            textContent: 'Summary',
        });
        this.summaryProducts = (0, create_element_1.newTag)('h3', {
            className: 'summary-products',
            textContent: 'Products: 0',
        });
        this.summaryTotalPrice = (0, create_element_1.newTag)('h3', {
            className: 'summary-total',
            textContent: 'Total: $0',
        });
        this.summaryPromoCode = (0, create_element_1.newTag)('input', {
            id: 'summary-promo-code',
            type: 'text',
            size: '5',
        });
        this.summaryBuy = (0, create_element_1.newTag)('button', {
            id: 'summary-buy',
            textContent: 'BUY NOW',
        });
        this.orderButton = (0, create_element_1.newTag)('button', {
            id: 'order-button',
            textContent: 'ORDER',
        });
    ...
    addsToCart(index) {
        const product = data_json_1.default[index - 1];
        ...
        const image = (0, create_element_1.newTag)('img', {
...
/***/ "./src/components/catalog-card.ts":
/*!****************************************!*\
  !*** ./src/components/catalog-card.ts ***!
  \****************************************/
...
const create_element_1 = __webpack_require__(/*! ./create-element */ "./src/components/create-element.ts");
const modal_1 = __webpack_require__(/*! ./modal */ "./src/components/modal.ts");
const cart_1 = __webpack_require__(/*! ./cart */ "./src/components/cart.ts");
class CatalogCard {
    constructor({ title, images, price, description }, index) {
        ...
        this.cardContainer = (0, create_element_1.newTag)('li', {
            className: 'product-card',
        });
        this.cardContainer.setAttribute('data-id', `${index + 1}`);
        this.card = (0, create_element_1.newTag)('div', { className: 'card' });
        // img
        this.cardImg = (0, create_element_1.newTag)('img', {
            className: 'card__img',
            src: this.thumbnail,
            width: 150,
            alt: this.title,
        ...
        // card body
        this.cardBody = (0, create_element_1.newTag)('div', { className: 'card-body' });
        this.cardTitle = (0, create_element_1.newTag)('h3', {
            className: 'item-title',
            innerText: this.title,
        });
        // btn open modal
        this.btnOpenModal = (0, create_element_1.newTag)('button', {
            className: 'btn-link',
            innerHTML: 'Show more',
        });
        // price
        this.priceWrapper = (0, create_element_1.newTag)('div', { className: 'price-wrapper' });
        this.priceText = (0, create_element_1.newTag)('span', { innerText: ' $' });
        this.price = (0, create_element_1.newTag)('span', { className: 'price', innerText: this.price });
        // button add to cart
        this.btnBin = (0, create_element_1.newTag)('button', {
            className: 'btn',
    ...
    listenEvents() {
        ...
        this.btnBin.addEventListener('click', (event) => {
            ...
            new cart_1.Cart().addsToCart(event.path[3].attributes[1].nodeValue); //index of card
        });
    }
    openModal(title, description, thumbnail) {
        new modal_1.Modal(title, description, thumbnail).openModal();
    }
}
...
/***/ "./src/components/category-brand-filters.ts":
/*!**************************************************!*\
  !*** ./src/components/category-brand-filters.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CategoriesBrands = void 0;
const create_element_1 = __webpack_require__(/*! ./create-element */ "./src/components/create-element.ts");
class CategoriesBrands {
    constructor(name) {
        this.name = name;
        this.currentName = (0, create_element_1.newTag)('div', {
            className: 'checkbox-line',
        });
        this.currentName.classList.add('item-active');
        this.checkbox = (0, create_element_1.newTag)('input', {
            type: 'checkbox',
            id: this.name,
        });
        this.label = (0, create_element_1.newTag)('label', {
            innerText: this.name,
        });
    }
...
exports.CategoriesBrands = CategoriesBrands;


/***/ }),

/***/ "./src/components/create-element.ts":
/*!******************************************!*\
  !*** ./src/components/create-element.ts ***!
  \******************************************/
...
const create_element_1 = __webpack_require__(/*! ./create-element */ "./src/components/create-element.ts");
const select_filter_1 = __webpack_require__(/*! ./select-filter */ "./src/components/select-filter.ts");
class Filters {
    constructor() {
        this.filtersContainer = (0, create_element_1.newTag)('section', {
            className: 'filters-section',
        });
        //buttons
        this.resetFilters = (0, create_element_1.newTag)('div', { className: 'filters-reset' });
        this.resetButton = (0, create_element_1.newTag)('button', {
            id: 'filters-reset-button',
            innerText: 'Reset Filters',
        });
        this.saveButton = (0, create_element_1.newTag)('button', {
            id: 'filters-save',
            innerText: 'Copy Filters',
        });
        //category
        this.filtersCategory = (0, create_element_1.newTag)('div', { className: 'filters-category' });
        this.filtersCategoryName = (0, create_element_1.newTag)('h3', { className: 'filters-category-name' });
        this.filtersCategoryList = (0, create_element_1.newTag)('div', { className: 'filters-category-list' });
        //brand
        this.filtersBrand = (0, create_element_1.newTag)('div', { className: 'filters-brand' });
        this.filtersBrandName = (0, create_element_1.newTag)('h3', { className: 'filters-brand-name' });
        this.filtersBrandList = (0, create_element_1.newTag)('div', { className: 'filters-brand-list' });
        //price
        this.filtersPrice = (0, create_element_1.newTag)('div', { className: 'filters-price' });
        this.filtersPriceName = (0, create_element_1.newTag)('h3', { className: 'filters-price-name' });
        this.filtersPriceData = (0, create_element_1.newTag)('div', { className: 'filters-price-data' });
        this.filtersPriceFrom = (0, create_element_1.newTag)('div', { className: 'filters-price-from' });
        this.filtersPriceTo = (0, create_element_1.newTag)('div', { className: 'filters-price-to' });
        //stock
        this.filtersStock = (0, create_element_1.newTag)('div', { className: 'filters-stock' });
        this.filtersStockName = (0, create_element_1.newTag)('h3', { className: 'filters-stock-name' });
        this.filtersStockData = (0, create_element_1.newTag)('div', { className: 'filters-stock-data' });
        this.filtersStockFrom = (0, create_element_1.newTag)('div', { className: 'filters-stock-from' });
        this.filtersStockTo = (0, create_element_1.newTag)('div', { className: 'filters-stock-to' });
        this.listenEvents();
    }
    renderFilters() {
    ...
    listenEvents() {
        this.filtersCategory.addEventListener('click', (event) => {
            ...
            (0, select_filter_1.selectCategory)();
            // this.setToLocalStorage();
        });
    }
}
...
class Header {
    constructor() {
        this.header = (0, create_element_1.newTag)('header', { className: 'header' });
        this.headerWrapper = (0, create_element_1.newTag)('div', {
            className: 'header-wrapper',
        });
        this.logo = (0, create_element_1.newTag)('h1', {
            className: 'logo',
            textContent: 'Online Store',
        });
        this.cartTotal = (0, create_element_1.newTag)('div', {
            className: 'cart-total',
            textContent: 'Cart total: 0$',
        });
        this.cartButton = (0, create_element_1.newTag)('div', {
            className: 'cart-button',
        });
        this.cartCounter = (0, create_element_1.newTag)('div', {
...
const catalog_card_1 = __webpack_require__(/*! ./catalog-card */ "./src/components/catalog-card.ts");
const category_brand_filters_1 = __webpack_require__(/*! ./category-brand-filters */ "./src/components/category-brand-filters.ts");
const select_filter_1 = __webpack_require__(/*! ./select-filter */ "./src/components/select-filter.ts");
function getCards() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            renderProducts(select_filter_1.selectCategoryArray);
        }
        catch (error) {
            console.log(error);
        }
...
function renderProducts(array) {
    ...
    array.forEach((data, index) => {
        const card = new catalog_card_1.CatalogCard(data, index);
    ...
    category.forEach((item) => {
        const category = new category_brand_filters_1.CategoriesBrands(item);
        filtersCategory.append(category.renderCategoriesBrands());
    });
    brands = [...new Set(brands)];
    const filtersBrand = document.querySelector('.filters-brand-list');
    brands.forEach((item) => {
        const brand = new category_brand_filters_1.CategoriesBrands(item);
...
exports.Main = void 0;
const create_element_1 = __webpack_require__(/*! ./create-element */ "./src/components/create-element.ts");
const product_catalog_1 = __webpack_require__(/*! ./product-catalog */ "./src/components/product-catalog.ts");
const filters_1 = __webpack_require__(/*! ./filters */ "./src/components/filters.ts");
const cart_1 = __webpack_require__(/*! ./cart */ "./src/components/cart.ts");
const order_form_1 = __webpack_require__(/*! ./order-form */ "./src/components/order-form.ts");
class Main {
    constructor() {
        this.main = (0, create_element_1.newTag)('main');
        this.container = (0, create_element_1.newTag)('div', { className: 'container open' });
    }
    render() {
        this.main.append(new cart_1.Cart().renderCart());
        this.main.append(this.container);
        this.main.append(new order_form_1.Form().render());
        this.container.append(new filters_1.Filters().renderFilters());
        this.container.append(new product_catalog_1.ProductCatalog().render());
        return this.main;
    }
}
exports.Main = Main;
...
class Modal {
    constructor(title, description, thumbnail) {
        this.overlay = (0, create_element_1.newTag)('div', { className: 'pop-up-background' });
        this.modal = (0, create_element_1.newTag)('div', { className: 'modal' });
        this.cardImg = (0, create_element_1.newTag)('img', {
            className: 'card__img',
            src: thumbnail,
            width: 200,
        ...
        this.textContainer = (0, create_element_1.newTag)('div', { className: 'modal-text-container' });
        // title
        this.title = (0, create_element_1.newTag)('h3', {
            className: 'modal-title',
            innerHTML: title,
        });
        // description
        this.description = (0, create_element_1.newTag)('p', {
            className: 'modal-description',
            innerHTML: description,
        });
        // close button
        this.btnCloseModal = (0, create_element_1.newTag)('button', {
...
class Form {
    constructor() {
        this.formWrapper = (0, create_element_1.newTag)('div', {
            className: 'form__section',
        });
        this.form = (0, create_element_1.newTag)('form', {
            className: 'order-form',
            action: '../dist/order.html',
        });
        this.nameLabel = (0, create_element_1.newTag)('label', {
            className: 'name-label label',
            innerHTML: 'Name',
        });
        this.name = (0, create_element_1.newTag)('input', {
            className: 'name-input input',
            type: 'text',
            pattern: '^[A-Za-z]{4,}$',
            required: true,
        });
        this.surnameLabel = (0, create_element_1.newTag)('label', {
            className: 'surname-label label',
            innerHTML: 'Surname',
        });
        this.surname = (0, create_element_1.newTag)('input', {
            className: 'surname-input input',
            type: 'text',
            required: true,
            pattern: '^[A-Za-z]{5,}$',
        });
        this.deliveryLabel = (0, create_element_1.newTag)('label', {
            className: 'delivery-label label',
            innerHTML: 'Delivery',
        });
        this.delivery = (0, create_element_1.newTag)('input', {
            className: 'delivery-input input',
            type: 'date',
            required: true,
            min: '2022-12-23',
        });
        this.streetLabel = (0, create_element_1.newTag)('label', {
            className: 'street-label label',
            innerHTML: 'Street',
        });
        this.street = (0, create_element_1.newTag)('input', {
            className: 'street-input input',
            type: 'text',
            required: true,
            pattern: '^[A-Za-z0-9][A-Za-z0-9 ]{5,}$',
        });
        this.houseLabel = (0, create_element_1.newTag)('label', {
            className: 'house-label label',
            innerHTML: 'House number',
        });
        this.house = (0, create_element_1.newTag)('input', {
            className: 'house-input input',
            type: 'number',
            required: true,
            pattern: '^[1-9]*$',
        });
        this.flatLabel = (0, create_element_1.newTag)('label', {
            className: 'flat-label label',
            innerHTML: 'Flat number',
        });
        this.flat = (0, create_element_1.newTag)('input', {
            className: 'flat-input input',
            type: 'text',
            required: true,
            pattern: '^[1-9–]+[-0-9–]*$',
        });
        this.fieldset = (0, create_element_1.newTag)('fieldset');
        this.legend = (0, create_element_1.newTag)('legend', {
            innerHTML: 'Choose the payment type',
        });
        this.cashContainer = (0, create_element_1.newTag)('div', {
            className: 'cash-container',
        });
        this.cash = (0, create_element_1.newTag)('input', {
            className: 'cash-input',
            type: 'radio',
            name: 'payment-type',
            id: 'cash',
        });
        this.cashLabel = (0, create_element_1.newTag)('label', {
            className: 'cash-label',
            innerHTML: 'Cash',
            for: 'cash',
        });
        this.cardContainer = (0, create_element_1.newTag)('div', {
            className: 'card-container',
        });
        this.card = (0, create_element_1.newTag)('input', {
        ...
        this.cardLabel = (0, create_element_1.newTag)('label', {
            className: 'card-label',
            innerHTML: 'Card',
            for: 'card',
        });
        this.inputButton = (0, create_element_1.newTag)('input', {
    ...
    render() {
        ...
        this.form.append(this.nameLabel, this.surnameLabel, this.deliveryLabel, this.streetLabel, this.houseLabel, this.flatLabel, this.fieldset, this.inputButton);
...
class ProductCatalog {
    constructor() {
        this.productCatalog = (0, create_element_1.newTag)('section', { className: 'catalog-container' });
        this.title = (0, create_element_1.newTag)('h2', {
            className: 'main__title',
            innerText: 'Catalog',
        });
        this.cardsList = (0, create_element_1.newTag)('ul', { className: 'cards__list' });
    }
    render() {
...
const main_1 = __webpack_require__(/*! ./main */ "./src/components/main.ts");
const header_1 = __webpack_require__(/*! ./header */ "./src/components/header.ts");
const overlay_1 = __webpack_require__(/*! ./overlay */ "./src/components/overlay.ts");
...
function renderingApp() {
    const app = document.querySelector('body');
    if (app) {
        app.append(new header_1.Header().render());
        app.append(new main_1.Main().render());
        app.append(new overlay_1.Overlay().render());
    }
}
...
/***/ "./src/components/select-filter.ts":
/*!*****************************************!*\
  !*** ./src/components/select-filter.ts ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.selectCategoryArray = exports.selectCategory = void 0;
const data_json_1 = __importDefault(__webpack_require__(/*! ../data.json */ "./src/data.json"));
let selectCategoryArray = data_json_1.default;
exports.selectCategoryArray = selectCategoryArray;
function selectCategory() {
    const selectCategoryAll = document.querySelectorAll('.select');
    exports.selectCategoryArray = selectCategoryArray = [];
    selectCategoryAll.forEach((el) => {
        data_json_1.default.forEach((e) => {
            if (e.category === el.id) {
    ...
    if (selectCategoryAll.length === 0) {
        exports.selectCategoryArray = selectCategoryArray = data_json_1.default;
    }
...
__webpack_require__(/*! ./components/render */ "./src/components/render.ts");
__webpack_require__(/*! ./components/loader */ "./src/components/loader.ts");
...
module.exports = __webpack_require__.p + "assets/4301741d4a45fd82da93.svg";
...
module.exports = __webpack_require__.p + "assets/6412203eded8f47ef29b.svg";
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_css-loader_dist_runtime_api_js-node_modules_css-loader_dist_runtime_cssW-4fc504"], () => (__webpack_require__("./src/index.ts")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	
/******/ })()
;
//# sourceMappingURL=main.f6a4b3482933c44796c8.js.map